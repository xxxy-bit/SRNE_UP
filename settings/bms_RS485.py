...
def get_bms_rs485_list():
    bms_rs485_list = {
        "获取PACK模拟量响应信息":{
            ...
            "监测温度个数":[136, 4, 1, ""],
            f"{palnum_label2}_1":[140, 8, -1, "℃"],
            f"{palnum_label2}_2":[148, 8, -1, "℃"],
            f"{palnum_label2}_3":[156, 8, -1, "℃"],
            f"{palnum_label2}_4":[164, 8, -1, "℃"],
            f"{palnum_label2}_5":[172, 8, -1, "℃"],
            f"{palnum_label2}_6":[180, 8, -1, "℃"],
