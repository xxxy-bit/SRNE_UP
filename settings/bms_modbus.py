...
def get_bms_modbus_list():
    bms_data_list = {
        "01030300005ec476":{
            ...
            "cell_1(V)":[30, 1, 1000, "V"],
            "cell_2(V)":[31, 1, 1000, "V"],
            "cell_3(V)":[32, 1, 1000, "V"],
            "cell_4(V)":[33, 1, 1000, "V"],
            "cell_5(V)":[34, 1, 1000, "V"],
            "cell_6(V)":[35, 1, 1000, "V"],
            "cell_7(V)":[36, 1, 1000, "V"],
            "cell_8(V)":[37, 1, 1000, "V"],
            "cell_9(V)":[38, 1, 1000, "V"],
            "cell_10(V)":[39, 1, 1000, "V"],
            "cell_11(V)":[40, 1, 1000, "V"],
            "cell_12(V)":[41, 1, 1000, "V"],
            "cell_13(V)":[42, 1, 1000, "V"],
            "cell_14(V)":[43, 1, 1000, "V"],
            "cell_15(V)":[44, 1, 1000, "V"],
            "cell_16(V)":[45, 1, 1000, "V"],
            "cell平均电压":[46, 1, 1000, "V"],
            vol_label17 + "(V)":[47, 1, 1000, "V"],
            vol_label18 + "(V)":[48, 1, 1000, "V"],
            vol_label19 + "(V)":[49, 1, 1000, "V"],
            "最低电压对应的cell":[50, 1, 1, ""],
            "最高电压对应的cell":[51, 1, 1, ""],
            "失效的cell":[52, 1, 1, ""],
            "cell_1(℃)":[53, 1, -10, "℃"],
        ...
        "01032007005bbe30":{
            ...
            parset7_label3 + "(S)":[39, 1, 1000, "202e"],
            parset7_label4 + "(A)":[40, 1, 100, "202f"],
            parset7_label5 + "(S)":[41, 1, 1000, "2030"],
            "放电过流保护最高次数":[42, 1, 1],
            "短路保护电流":[43, 1, 1],
            ...
            "电芯压差保护开启压差值":[82, 1, 1],
            "电芯压差保护解除压差值":[83, 1, 1],
            parset6_label7 + "(V)":[84, 1, 100, "205b"],
